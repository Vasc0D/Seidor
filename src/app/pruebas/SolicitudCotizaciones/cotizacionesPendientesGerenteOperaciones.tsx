...
const CotizacionesPendientes = () => {
  ...
  const fetchCotizacionesPendientes = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_IP}/api/cotizaciones_servicios/pendientes`, {
        method: 'GET',
        credentials: 'include',
      });
  ...
  const handleEnviarCotizacion = async (cotizacionId: string) => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_IP}/api/cotizaciones_servicios/enviar/${cotizacionId}`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
  ...
  const handleEstadoChange = async (conceptoId: string, nuevoEstado: string) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_IP}/api/cotizaciones_servicios/conceptos/${conceptoId}/estado`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
